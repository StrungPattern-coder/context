/**
 * ═══════════════════════════════════════════════════════════════════════════════
 *         RAL MASTER INJECTOR - Perplexity v4.6 (Single Source of Truth)
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * The definitive, self-contained Perplexity integration. Zero external dependencies.
 * 
 * @version 4.6.0
 * @license MIT
 */
...
(function() {
  ...
  console.log(`RAL Master Injector v${RAL_VERSION} [Perplexity] loaded`);
  ...
  function setupGhostContextScrubber() {
    ...
    const container = document.querySelector('[class*="answer"]') || document.querySelector('main') || document.body;
    scrubber.observe(container, { childList: true, subtree: true });

    // Initial scrub
    scrubContextFromElement(document.body);
    console.log('RAL v4.6 [Perplexity]: Flicker-Free Ghost Scrubber active');
  }
  ...
  async function injectContext(element) {
    ...
    if (success) {
      ...
      console.log('RAL v4.6 [Perplexity]: Context injected!');
    }
    return success;
  }

  // ════════════════════════════════════════════════════════════════════════════
  //                          DOM HELPERS (PERPLEXITY-SPECIFIC)
  // ════════════════════════════════════════════════════════════════════════════

  function findInput() {
    const selectors = [
      // Perplexity main search/chat input
  ...
  async function init() {
    ...
    console.log(`RAL Master Injector v${RAL_VERSION} [Perplexity]: Ready! 🧠⚡`);
  }
