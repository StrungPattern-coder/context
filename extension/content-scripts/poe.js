/**
 * ═══════════════════════════════════════════════════════════════════════════════
 *         RAL MASTER INJECTOR - Poe v4.6 (Single Source of Truth)
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * The definitive, self-contained Poe.com integration. Zero external dependencies.
 * 
 * @version 4.6.0
 * @license MIT
 */
...
(function() {
  ...
  console.log(`RAL Master Injector v${RAL_VERSION} [Poe] loaded`);
  ...
  function setupGhostContextScrubber() {
    ...
    const container = document.querySelector('[class*="Message"]') || document.querySelector('main') || document.body;
    scrubber.observe(container, { childList: true, subtree: true });

    // Initial scrub
    scrubContextFromElement(document.body);
    console.log('RAL v4.6 [Poe]: Flicker-Free Ghost Scrubber active');
  }
  ...
  async function injectContext(element) {
    ...
    if (success) {
      ...
      console.log('RAL v4.6 [Poe]: Context injected!');
    }
    return success;
  }

  // ════════════════════════════════════════════════════════════════════════════
  //                          DOM HELPERS (POE-SPECIFIC)
  // ════════════════════════════════════════════════════════════════════════════

  function findInput() {
    const selectors = [
      // Poe main input (textarea with GrowingTextArea class)
  ...
  function findSendButton() {
    const selectors = [
      'button.ChatMessageSendButton_sendButton__4ZyI4',
  ...
  async function init() {
    ...
    console.log(`RAL Master Injector v${RAL_VERSION} [Poe]: Ready! 🧠⚡`);
  }
